/** Baseline security headers for Next.js (PR-29). CSP allows Stripe Embedded Checkout + Supabase. */

const STRIPE_ORIGINS = 'https://js.stripe.com https://hooks.stripe.com https://checkout.stripe.com'
