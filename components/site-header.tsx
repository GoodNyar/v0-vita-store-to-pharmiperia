...
export function SiteHeader() {
  ...
  return (
    ...
    <header className="bg-card shadow-sm">
      ...
      {/* Category Navigation — categories collapse on scroll, Specials/Popular stay visible */}
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="flex items-center justify-between py-1">
            ...
            <div className="flex-shrink-0">
              <Link
                href="/promotions"
                className="px-3 py-2 text-sm font-medium text-destructive hover:text-destructive/80 transition-colors"
              >
                {t("specials")}
              </Link>
            </div>
