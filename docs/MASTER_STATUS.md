...
| **Аудит RC** | [Отчёт 23](reports/23-final-release-candidate-audit.md) — WARNING → **RC зафиксирован** |
...
| Документ | Назначение |
|----------|------------|
| [Release Notes v1.0.0-rc.1](releases/v1.0.0-rc.1.md) | Состав RC, фиксы, ограничения |
| [RELEASE_CHECKLIST.md](RELEASE_CHECKLIST.md) | RC-гейт (B-1, B-2) |
...
| [ENGINEERING_PLAYBOOK.md](ENGINEERING_PLAYBOOK.md) | Правила разработки |
