...
const trustBadges = [
  { icon: Truck, label: "Free Shipping", desc: "On orders $30+" },
  { icon: Shield, label: "Authentic", desc: "100% Guaranteed" },
            ...
            <section className="mt-12 mb-8 rounded-xl bg-primary px-6 py-8 sm:px-10">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-2 max-w-md text-sm text-primary-foreground/80">
                  Get exclusive deals, health tips, and new product updates delivered
